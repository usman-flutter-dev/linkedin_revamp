...
import 'package:linkedin_revamp/shared/widgets/linkedin_logo.dart';
import 'package:linkedin_revamp/shared/widgets/linkedin_refresh_indicator.dart';
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return LinkedInRefreshIndicator(
      onRefresh: () async {
        // Yahan apna data refresh logic likhein
        // Ya simple delay for testing:
        // await Future.delayed(const Duration(seconds: 1));
      },
      refreshDuration: Duration(
        seconds: 2,
      ), // logo kitna dair dikhe — default 1.5s
      pulseDuration: Duration(
        milliseconds: 1500,
      ), // pulse ki speed — default 700ms
      triggerOffset: 260, // kitna pull karna pade — default 80px
      // logoSize: 48,
      child: Scaffold(
